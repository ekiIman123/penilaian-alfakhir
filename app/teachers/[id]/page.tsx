    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div>
        ...
        <div
          ...
          style={{ boxShadow: "0 2px 12px rgba(15,37,64,0.15)" }}
        >
          {/* Gradient header */}
          <div
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                ...
                <h1 className="text-xl font-bold leading-snug">{teacher.name}</h1>
                <p className="text-xs mt-1" style={{ color: "rgba(255,255,255,0.50)" }}>SMP Al Fakhir · TA 2025/2026</p>
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-xs font-bold" style={{ color: avg != null ? s.color : "rgba(255,255,255,0.35)" }}>
      ...
      {parsedEvals.length > 0 && (
        <div className="card">
          <div className="px-5 py-3.5" style={{ borderBottom: "1px solid #DDE3EC" }}>
            <h2 className="font-semibold text-slate-800">Perbandingan Nilai per Aspek</h2>
            <p className="text-xs text-slate-400 mt-0.5">Nilai mentah per seksi dari setiap penilai</p>
          </div>
          <div className="p-4">
      ...
      <div className="card">
        <div className="px-5 py-3.5 flex items-center justify-between" style={{ borderBottom: "1px solid #DDE3EC" }}>
          <h2 className="font-semibold text-slate-800">Detail Penilaian per Penilai</h2>
          <span className="text-xs text-slate-400">{parsedEvals.length}/{allEvaluators.length} penilai</span>
        </div>

        {parsedEvals.length === 0 ? (
          <div className="p-8 text-center text-slate-400 text-sm">Belum ada penilaian</div>
        ) : (
          <div>
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between gap-3 mb-3">
                    <div className="flex items-center gap-2.5 min-w-0">
                      ...
                      <div className="min-w-0">
                        <div className="font-semibold text-slate-800 text-sm leading-snug">{e.evaluator.name}</div>
                  ...
                  {e.catatan && (
                    ...
                    >
                      <p className="text-xs font-semibold mb-0.5" style={{ color: "#1E3A5F" }}>Catatan</p>
                      <p className="text-xs text-slate-600 leading-relaxed">{e.catatan}</p>
                    </div>
                  )}
                </div>
              )
      ...
      {missingEvaluators.length > 0 && (
        <div className="card">
          <div className="px-5 py-3.5" style={{ borderBottom: "1px solid #DDE3EC" }}>
            <h2 className="font-semibold text-slate-800">Penilai yang Belum Menilai</h2>
      ...
      <div className="card">
        <div className="px-5 py-3.5" style={{ borderBottom: "1px solid #DDE3EC" }}>
          <h2 className="font-semibold text-slate-800">Detail Skor per Kriteria</h2>
          ...
          <table className="w-full text-xs">
            <thead>
              <tr style={{ backgroundColor: "#F0F4F9" }}>
                <th className="text-left px-5 py-2.5 font-semibold text-slate-500 uppercase tracking-wide min-w-[200px]">Kriteria</th>
                {parsedEvals.map((e) => {
                ...
                {parsedEvals.length > 1 && (
                  <th className="text-center px-4 py-2.5 font-semibold text-slate-500 uppercase tracking-wide">Rata-rata</th>
                )}
              </tr>
            </thead>
            <tbody>
